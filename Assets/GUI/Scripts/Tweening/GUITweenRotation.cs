...
[AddComponentMenu("GUI/Tween/Tween Rotation")]
public class GUITweenRotation : GUITweener 
{
    public Vector3 from;
    public Vector3 to;
    ...
    static public GUITweenRotation Begin(GameObject go, float duration, Quaternion rot)
    {
        GUITweenRotation comp = GUITweener.Begin<GUITweenRotation>(go, duration);
