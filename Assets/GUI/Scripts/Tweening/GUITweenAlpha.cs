...
[AddComponentMenu("GUI/Tween/Tween Alpha")]
public class GUITweenAlpha : GUITweener 
{
    [Range(0f, 1f)]
    ...
    static public GUITweenAlpha Begin(GameObject go, float duration, float alpha)
    {
        GUITweenAlpha comp = GUITweener.Begin<GUITweenAlpha>(go, duration);
